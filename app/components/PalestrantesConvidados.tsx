...
const palestrantes: Palestrante[] = [
  ...
  },
  {
    ...
    curriculo: 'Graduada em Medicina pela Universidade do Estado do Pará (UEPA, 2008), com pós-graduação em Dermatologia, Alergologia e Imunologia, é médica hansenologa. É membro titular da Sociedade Brasileira de Dermatologia (SBD), membro titular da Sociedade Brasileira de Hansenologia (SBH), titular do Grupo Brasileiro de Melanoma (GBM) e sócia da ASBAI. Mestra pelo Programa Profissional em Cirurgia Experimental (CIPE) e professora assistente das disciplinas de habilidades em dermatologia e infectologia da Universidade do Estado do Pará. Médica dermatologista responsável pelo Ambulatório de Dermatologia e Hanseníase da Amazônia, atua como orientadora da Liga Marabaense de Dermatologia (LIMDERM) e é médica responsável pela Clínica Alergopele. Desenvolve atividades de pesquisa, ensino e extensão nas áreas de imunologia, hanseníase e dermatologia, com ênfase em doenças infectocontagiosas, oncologia cutânea, hanseníase, imunopatogênese, cirurgia dermatológica, doenças imunomediadas e ensino médico.',
    resumo: 'Graduada em Medicina pela Universidade do Estado do Pará (UEPA, 2008), com pós-graduação em Dermatologia, Alergologia e Imunologia, é médica hansenologa. É membro titular da Sociedade Brasileira de Dermatologia (SBD), membro titular da Sociedade Brasileira de Hansenologia (SBH), titular do Grupo Brasileiro de Melanoma (GBM) e sócia da ASBAI.\n\nMestra pelo Programa Profissional em Cirurgia Experimental (CIPE) e professora assistente das disciplinas de habilidades em dermatologia e infectologia da Universidade do Estado do Pará. Médica dermatologista responsável pelo Ambulatório de Dermatologia e Hanseníase da Amazônia, atua como orientadora da Liga Marabaense de Dermatologia (LIMDERM) e é médica responsável pela Clínica Alergopele.\n\nDesenvolve atividades de pesquisa, ensino e extensão nas áreas de imunologia, hanseníase e dermatologia.\n\nAtua em Dermatologia, com ênfase em doenças infectocontagiosas, oncologia cutânea, hanseníase, imunopatogênese, cirurgia dermatológica, doenças imunomediadas e ensino médico.',
  },
  {
