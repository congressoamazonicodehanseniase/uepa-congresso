    ...
    <section id="inscricoes" className="pt-16 sm:pt-24 pb-8 sm:pb-12 bg-surface">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4 mb-12">
          <div>
            ...
            <h2 className="display text-ink" style={{ fontSize: 'clamp(2rem, 4.5vw, 3.4rem)' }}>
              Inscreva-se agora —<br />1º, 2º e 3º lotes <span className="italic text-brand-strong mark">esgotados</span>
            </h2>
          </div>
        ...
        <div className="mt-4 mb-6 flex items-center gap-3 text-xs">
          <span className="font-semibold text-muted whitespace-nowrap line-through">1º, 2º e 3º lotes esgotados</span>
